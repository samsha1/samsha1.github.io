...
},
{
  ...
  render:(
    <div className="portfolio-item">
        ...
        <div className="portfolio-item__desc">Testing code is one of the most important part to understand your application and behavior of code.Every developer knows how painful bugs can be, especially in the production stage as it takes hours of hard work....
        </div>
        <div className="portfolio-item__icon">
          <IconContext.Provider value={{ color: "#3B80F7",size:"1em", className: "global-class-name" }}><FaPhp /> </IconContext.Provider>
        </div>
        <div className="portfolio-item__links">
          <a target="_blank" rel="noopener noreferrer" href="https://dev.to/samsha1/how-you-test-your-code-3e4o">Blog</a>
        </div>
    </div>
...
},
{
  ...
  render:(
    <div className="portfolio-item">
        ...
        <div className="portfolio-item__links">
          <a target="_blank" rel="noopener noreferrer" href="https://gregoryjewellers.com.au">Visit Site</a>
        </div>
    </div>
